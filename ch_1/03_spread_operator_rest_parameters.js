 ...
 * 
 * spread operator => ...
 * 이터러블(iterable)은 ES6 이커러블 규약(iterable protocol)에 따라 값을 여럿 가지며 개별 값을 순회 가능한 객체다. 대표적으로 배열.
 * */
...
// 펼침 연산자는 apply()메소드를 호출하지 않는다. 자바스크립트 실행 엔진이 이터레이션 규약에 따라 배열을 펼치는 것일 뿐, apply()와는 아무런 관련이 없다.
***/

/**
 * 펼침 연산자는 원소가 만히 나오는 곳이면 어디라도 활용할 수 있다.
 */
